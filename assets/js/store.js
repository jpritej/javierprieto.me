...
const UI = {
  es: {
    ...
    "p.ip": "IP",
    "p.web": "Ver web",
    "export.xlsx": "Exportar a Excel",
    "export.fail": "Exportación no disponible",
    "x.year": "Año", "x.type": "Tipo", "x.title": "Título", "x.venue": "Revista o congreso",
    "x.url": "Enlace", "x.program": "Programa", "x.code": "Código", "x.funder": "Financiador",
    "x.role": "Participación", "x.scope": "Ámbito", "x.start": "Inicio", "x.end": "Fin",
    "p.ongoing": "en curso",
    ...
    "sec.path": "Experiencia destacada",
    ...
    "sec.allpubs": "Ver todas las publicaciones",
    ...
    "pubs.quartileNote": (n, tot) => `Cuartil calculado a partir de la posición de la revista en su categoría, según los datos de Web of Science recogidos en el CVN: ${n} de ${tot} publicaciones del CVN tienen ese dato.`,
  ...
  en: {
    ...
    "export.fail": "Export unavailable",
    "x.year": "Year", "x.type": "Type", "x.title": "Title", "x.venue": "Journal or conference",
    "x.url": "Link", "x.program": "Programme", "x.code": "Code", "x.funder": "Funder",
    "x.role": "Role", "x.scope": "Scope", "x.start": "Start", "x.end": "End",
    "p.ongoing": "ongoing",
    ...
    "about.copy": "Copy this text",
    "about.copied": "Copied",
    "about.copyFail": "Could not copy",
    "sec.topics": "Research lines",
    "sec.path": "Selected positions",
    ...
    "pubs.quartileNote": (n, tot) => `Quartile derived from the journal's rank within its category, using the Web of Science data recorded in the CVN: ${n} of ${tot} CVN publications carry it.`,
